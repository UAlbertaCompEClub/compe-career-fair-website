        ...
        <div className="block overview-block" id="overview-block">
            <div className="overview-content">
                <div className="overview-text" id="overview-text">
                    <h2 className="colored-text">Are you ready to land a tech internship or full-time position for Winter/Summer 2025?</h2>
                    ...
                    <p>   
                    In 2024, the inaugural Aether (previously Career++) surpassed our expectations with an <strong>astounding 1200 participants!</strong> This year we are excited to bring back this extraordinary event on the 10th to 11th of October and tentatively expect more than 2000 participants!
                    </p>
                ...
                <div className="overview-text gradient-border-padded" id="overview-text">
                    <h3 className="text-main">
                        Aether will run from <em>11:00 AM to 4:45 PM virtually </em> on November 21st and from <em>12:00 PM to 6:00 PM </em>
